        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#charts" aria-expanded="false" aria-controls="charts">
              ...
              <span class="menu-title">Banner</span><i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="charts">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{ route('slider.index') }}">Slider</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{ route('header-banners.index') }}">Header Banner</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{ route('footer-banners.index') }}">Footer Banner</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{ route('category_banner') }}">Category Banner</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="error">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{ route('services_index') }}">Service</a></li>
