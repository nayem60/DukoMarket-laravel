                              ...
                              @foreach($flash_product as $row)
                                <div class="product__item swiper-slide">
                                    <div class="product__thumb fix">
                                        ...
                                        @php
                                          $discount=round(($row->discount_price*100)/$row->price);
                                          $plush_discount=round(($row->price*100)/$row->discount_price);
                                        @endphp
                                        <div class="product__offer">
                                        @if($row->discount_price>$row->price)
                                         <span class="discount">+{{$plush_discount}}%</span>
                                        @else
                              ...
                              @foreach($product->take(10) as $products)
                                <div class="product__item mb-20 swiper-slide">
                                    <div class="product__thumb fix">
                                        ...
                                        @php
                                           $discount=round($products->discount_price*100/$products->price);
                                           $plush_discount=round($products->price*100/$products->discount_price);
                                        @endphp
