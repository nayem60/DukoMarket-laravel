                    ...
                    <div class="col-xl-3 col-lg-4">
                        <div class="product-widget mb-30">
                            ...
                            <div class="widget-category-list mt-20">
                                ...
                                <form id="sub_form">
                                  <input type="hidden" id="subId" name="subcategory" value="{{ $subcategory_id }}">
                                </form>
                            </div>
                        </div>
                        <div class="product-widget mb-30">
                            ...
                            <div class="price__slider mt-30">
                                ...
                                <div>
                                    <form action="" class="s-form mt-20">
                                        <input type="number" name="min" value="{{ $min }}" class="border border-warning text-center p-1" placeholder="Min"> &nbsp To &nbsp <input type="number" name="max" value="{{ $max }}" class="border border-warning text-center p-1" placeholder="Max">
                                        &nbsp &nbsp<button type="submit" class="tp-btn-square-lg btn btn-warning btn-sm rounded-pill ml-3"><i class="far fa-search-plus" style="font-size:25px;color: white;"></i></button>
                                    </form>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="widget-category-list mt-20">
                                <form action="#">
                                  @foreach($color as $colors)
                                    <div class="single-widget-category">
                                      @if(in_array($colors->id,$unique_color))
                                        <input type="checkbox" checked onclick="colorFilter({{ $colors->id }},1)" id="choose-item-{{ $loop->index }}" name="choose-item">
                                        <label for="choose-item-{{ $loop->index }}">{{ $colors->name }} </label>
                                      @else
                                       <input type="checkbox" onclick="colorFilter({{ $colors->id }},0)" id="choose-item-{{ $loop->index }}" name="choose-item">
                                        <label for="choose-item-{{ $loop->index }}">{{ $colors->name }} </label>
                                ...
                                <form id="color_form">
                                  <input type="hidden" id="colorId" name="color" value="{{ $colorId }}">
                                </form>
                            </div>
                        </div>
                        @endif
                        ...
                        <form id="size_form">
                          <input type="hidden" id="sizeId"name="size" value="{{ $sizeId }}">
                        </form>
                            ...
                            <div class="widget-category-list mt-20">
                                <form action="#">
                                 @foreach($brand as $brands)
                                    <div class="single-widget-category">
                                      @if(in_array($brands->id,$brand_unique))
                                        <input type="checkbox" checked onclick="brandFilter({{ $brands->id }},1)" id="brand-item-1" name="brand-item">
                                        <label for="brand-item-1">{{ $brands->title}}</label>
                                      @else
                                       <input type="checkbox" onclick="brandFilter({{ $brands->id }},0)" id="brand-item-1" name="brand-item">
                                       <label for="brand-item-1">{{ $brands->title}}</label>
                                ...
                                <form id="brand_form">
                                  <input type="hidden" name="brand"id="brandId" value="{{ $brandId }}">
                                </form>
                            </div>
                        </div>
                    </div>
